<template>
    <div class="form-group w-25 mx-auto my-auto" style="background-color: #1E1D2E;">
    <h1 class="mt-5 ml-3" style="font-size:80px;">TicketMaster</h1>
        <card class="py-4 px-4" style="margin-top:100px;">
